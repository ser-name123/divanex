...
export const portfolioProjects: PortfolioProject[] = [
  ...
  },
  {
    id: "parana-tool",
    title: "Parana Tool",
    clientSubtitle: "Electronics Accessories",
    category: "E-Commerce",
    serviceTags: ["Mobile App", "Web Development", "UI/UX Design"],
    tagline: "Omnichannel B2B & D2C Electronics Accessories E-Commerce Experience",
    description:
      "Delivered an ultra-fast headless e-commerce store and companion mobile application for electronics tools and accessories, featuring instant SKU search, dynamic volume tiered pricing, and lightning checkout.",
    impactMetric: "+86%",
