          ...
          <div className="lg:col-span-4 space-y-4">
            ...
            <div className="space-y-2 text-xs font-mono">
              ...
              <div className="flex items-center justify-between p-2 rounded-xl bg-white border border-slate-200 hover:border-sky-300 transition-colors shadow-2xs">
                ...
                <button
                  type="button"
                  onClick={() => { navigator.clipboard.writeText(CONTACT_EMAIL); setCopiedEmail(true); setTimeout(() => setCopiedEmail(false), 2200); }}
              ...
              {/* Direct Phone Call & WhatsApp Button */}
              ...
              {/* Location Pill */}
              <div className="flex items-start gap-2 p-2 rounded-xl bg-white border border-slate-200/60 text-slate-500 text-[10.5px] leading-relaxed">
