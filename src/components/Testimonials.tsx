          ...
          {displayedItems.map((item: TestimonialItem) => (
            ...
            >
              <div className="space-y-4">
                {/* Rating, Verification & Project Badge */}
                <div className="flex items-center justify-between flex-wrap gap-2">
                  ...
                  <span className="text-[11px] font-bold uppercase tracking-wider px-2.5 py-1 rounded-full bg-sky-50 border border-sky-200 text-sky-800 font-mono">
                    {item.projectType}
                  </span>
                </div>
